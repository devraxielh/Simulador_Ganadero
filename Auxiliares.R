ganacia_de_peso <- function(temporada,potrero,f,s) { 
  # f es el forraje del potrero 
  # s el peso del lote que está en ese potrero
  ...
  if(Necesidad_nutricional*s>f){
    d = d*(f/(Necesidad_nutricional*s))
  }
...
asig2 = function(x,v,dias_descanso){
  contar = function(y){
    r = sum(y!=0)
    return(r)
  } 
